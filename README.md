<h1 align="center">
    <img src="https://raw.githubusercontent.com/Santoshkrishna-code/Santoshkrishna-code/main/Quote1.png" alt="Quotes Banner" width="100%" style="max-width: 1000px; border-radius: 10px;" />
</h1>
<h1 align="center">
  <img 
    src="https://readme-typing-svg.herokuapp.com/?font=Fira+Code&size=40&center=true&vCenter=true&width=700&height=90&duration=2500&pause=1200&color=9b59b6&background=00000000&lines=Explore+Innovation+🚀;Embrace+Creativity+🎨;Build+the+Future+Together!+💡" 
...
<div style="background: linear-gradient(135deg, #9b59b6, #8e44ad); padding:20px; border-radius:15px; color:white; box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.2); font-family: 'Arial', sans-serif;">
  <ul>
    <li>💻 <strong>Programming:</strong> From <strong>C</strong> to <strong>React</strong> and beyond, I love coding and problem-solving.</li>
    <li>🏀 <strong>Sports:</strong> As a <strong>Point Guard</strong> in basketball and a <strong>Goalkeeper</strong> in football, I thrive in team-based challenges.</li>
    <li>🎨 <strong>Creative Arts:</strong> Skilled in <strong>watercolor painting</strong>.</li>
...
### ⚒️ Languages & Tools ⚒️
<div align="center">
    <img src="https://skillicons.dev/icons?i=vscode,github,react,aws,docker,python,c,cpp,cs,java,blender,anaconda,linux,unity,unreal" alt="Languages & Tools" style="border-radius: 10px; box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.2);" />
</div>
